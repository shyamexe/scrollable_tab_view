...
void main() {
  ...
  group('ScrollableTab widget testing', () {
    ...
    testWidgets('initial state tests', (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(home: ScrollableTabWidget()));

      final text = find.text('tab Number 0');
      expect(text, findsOneWidget);
    });
    // Test case for tapping the second tab
    testWidgets('2nd tab tap tests', (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(home: ScrollableTabWidget()));
